...
static unsigned short keypad_keymap_u8300[KEYMAP_SIZE] = {
	...
	[KEYMAP_INDEX(3, 8)] = KEY_2,		//@, Correct it latter.
	[KEYMAP_INDEX(3, 9)] = KEY_ENTER, 
	
	[KEYMAP_INDEX(4, 0)] = KEY_CAPSLOCK,			//KEY_SOFT1,
	[KEYMAP_INDEX(4, 1)] = KEY_CAPSLOCK,
	[KEYMAP_INDEX(4, 2)] = KEY_0,		//What is smiley?
	[KEYMAP_INDEX(4, 3)] = 0,			//What is operator?
	[KEYMAP_INDEX(4, 4)] = 0,
	[KEYMAP_INDEX(4, 5)] = KEY_SPACE,
	[KEYMAP_INDEX(4, 6)] = 0,
	[KEYMAP_INDEX(4, 7)] = KEY_SEARCH,			//What is search?
	[KEYMAP_INDEX(4, 8)] = 0,			//What is Symbol?
	[KEYMAP_INDEX(4, 9)] = 0,	
};
#endif
